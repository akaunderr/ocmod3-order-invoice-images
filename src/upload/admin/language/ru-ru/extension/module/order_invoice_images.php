...
$_['error_permission']  = 'Внимание: Недостаточно прав для изменения настроек Order Invoice - Images!';
...
$_['text_success']      = 'Настройки Order Invoice - Images успешно изменены!';
$_['text_edit']         = 'Настройка Order Invoice - Images';
